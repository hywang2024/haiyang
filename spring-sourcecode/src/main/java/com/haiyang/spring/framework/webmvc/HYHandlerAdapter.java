...
public class HYHandlerAdapter {
    public boolean supports(Object handler){ return (handler instanceof HYHandlerMapping);}


    HYModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception{
        HYHandlerMapping handlerMapping = (HYHandlerMapping)handler;
        ...
        boolean isModelAndView = handlerMapping.getMethod().getReturnType() == HYModelAndView.class;
        if(isModelAndView){
